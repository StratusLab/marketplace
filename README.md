...
1. stratuslab_getimages.py downloads applicances metadata and dumps those that are subject to be downloaded (aka. images with an HTTP URI).
...
2. stratuslab_images_uri.py dumps URI only from a file containing the above script output. 
